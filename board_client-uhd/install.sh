...
echo ""
echo "Warning: This compatibility layer was entirely vibes-coded with"
echo "         Claude 4 Sonnet. While I've glanced over the code and"
echo "         it looks OK, don't blame me if it does something weird."
echo ""
